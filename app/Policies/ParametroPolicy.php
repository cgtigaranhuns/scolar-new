...
class ParametroPolicy
{
    ...
    {
       return $user->hasPermissionTo('Ver Parametro');
    }
    ...
    {
        return $user->hasPermissionTo('Criar Parametro');
    }
    ...
    {
        return $user->hasPermissionTo('Editar Parametro');
    }
    ...
    {
        return $user->hasPermissionTo('Deletar Parametro');
    }
