...
class TurmaPolicy
{
    ...
    {
        return $user->hasPermissionTo('Ver Turma');
    }
    ...
    {
        return $user->hasPermissionTo('Criar Turma');
    }
    ...
    {
        return $user->hasPermissionTo('Editar Turma');
    }
    ...
    {
        return $user->hasPermissionTo('Deletar Turma');
    }
