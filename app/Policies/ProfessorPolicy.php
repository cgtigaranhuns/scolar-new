...
class ProfessorPolicy
{
    ...
    {
        return $user->hasPermissionTo('Ver Professor');
    }
    ...
    {
        return $user->hasPermissionTo('Criar Professor');
    }
    ...
    {
        return $user->hasPermissionTo('Editar Professor');
    }
    ...
    {
        return $user->hasPermissionTo('Deletar Professor');
    }
